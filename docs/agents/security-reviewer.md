...
2. `docs/agents/project-state.md` — RBAC матрица, DB таблицы, shared schemas, auth flow
3. `docs/agents/memory/reviewer/lessons.md` — накопленные уроки (legacy общий с code-reviewer до Phase 4 split)
