...
2026-05-23 [P1] [dev-flow-rca] #zone-violation Если diff PR содержит изменения вне zone-of-write Coder'а (scripts/pm/**, docs/agents/**, .github/workflows/**) — Verdict: BLOCK с указанием конкретного файла. См. coder.md «Zone-of-write».
