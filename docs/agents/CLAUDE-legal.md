...
| Можно                                                         | Нельзя                                                 |
| ------------------------------------------------------------- | ------------------------------------------------------ |
| `docs/specs/tasks/task-legal-*.md` (append `## Ответ юриста`) | `docs/legal/**` (knowledge base — User/PM maintenance) |
| `docs/specs/legal-consultations/*.md`                         | `apps/**`, `packages/**`, `scripts/**`, `.github/**`   |
| `docs/specs/pm-brief-legal-check.md`                          | `docs/agents/**`                                       |
...
ls -la docs/specs/tasks/task-legal-<slug>.md
grep -c "^### " docs/specs/tasks/task-legal-<slug>.md  # сколько секций успел
