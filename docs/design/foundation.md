...
Брейкпоинты проверки: **320 / 768 / 1024 / 1440**.

- ≤768: sidebar → `Sheet`; таблицы → горизонтальный скролл или card-стек; одноколоночные формы.
- 1024–1440: основной desktop-таргет операторов.
- Стабильные размеры toolbar/grid/counters — не «прыгают» при hover/смене лейбла.
