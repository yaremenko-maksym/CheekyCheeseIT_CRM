...
| **1** | Interviews (канбан + 5 модалок)                                | in progress — канбан approved (2026-06-23) |
...
| ------------------------------------- | --------------------------------------------------------- | ---------------------------------------------------------------------------------------- | ------------- | ----------- |
| App-shell (nav-sidebar+header+chrome) | `docs/design/screens/_foundation/app-shell.md`            | [CRM глобальный каркас](https://claude.ai/design/p/cb5277cf-5b56-44ff-9a6a-4404d8c92cea) | `implemented` | `04ffd90b`  |
...
| --------------------------------- | ---------------------------------- | ------------------------------------------------------------- | ---------- |
| Канбан-доска (`/interviews`)      | `index.tsx` + `KanbanColumn.tsx`   | `docs/design/screens/interviews/kanban.md`                    | `approved` |
