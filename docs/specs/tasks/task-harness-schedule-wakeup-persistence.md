...
- `docs/agents/CLAUDE-pm.md` — секция «⚠️ ScheduleWakeup limitations» с двумя слоями (Layer 1 = ScheduleWakeup, Layer 2 = mcp__scheduled-tasks)
- `docs/agents/pm-snippets.md` — сниппет «Cross-session wake-up (mcp__scheduled-tasks через pm-schedule.sh)»
