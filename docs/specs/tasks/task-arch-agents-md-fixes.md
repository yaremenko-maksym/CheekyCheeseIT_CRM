...
## Файлы:
- `docs/agents/{pm,coder,reviewer,autotest,devops}.md` — поведенческие фиксы
- `docs/agents/CLAUDE-pm.md` — schema + лимитации ScheduleWakeup
- `docs/agents/memory/README.md` — приоритетная схема + topic tag
- `docs/agents/memory/*/lessons.md` — retro-tag существующих уроков (P0/P1/P2)
...
- `docs/specs/tasks/task-*.md` (NEW sub-tasks для follow-up работы)
