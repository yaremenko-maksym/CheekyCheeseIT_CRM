...
- [x] **PHASE 6**: Документы (S3-совместимо: dev RustFS / prod Cloudflare R2 — MinIO удалён 2026-09-24, #709; `documents` table, PDF inline preview, search/sort, receipt lifecycle)
