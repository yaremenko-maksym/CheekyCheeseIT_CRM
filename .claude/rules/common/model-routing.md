...
| Tier       | Агенты                                                                        | Почему                                                                                        |
| ---------- | ----------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------- |
| **opus**   | `pm`, `security-reviewer`, `architect`, `legal`                               | Judgment-heavy: ошибка диспетча / пропущенный data-leak / кривой ADR стоят дороже 1.7× прайса |
...
| Task-файл: Drizzle-миграция + cross-module рефактор / финансовая расчётная логика / smart-contract код (PHASE 8) | Сразу `## Модель: opus` в task-файле          |
