...
**Решение владельца окончательное (уточнено 2026-09-01): убирать в любом виде.** Не менять
формат на приглашение с хешем, не прятать под условием — удалять. Спрашивать не нужно.
