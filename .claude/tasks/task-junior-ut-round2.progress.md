...
- [x] HIGH-2 — users-access.service.spec.ts no-op mock rename + masking test (44 tests pass)
- [x] MED-3 — ProfileCredentialsSection 30s auto-hide (CSS timer bar mirror)
