...
Процент проекта или личный дефолт, причитающийся синьору. Резолвер проверяет три уровня по
убыванию приоритета — проект → команда → личный дефолт синьора — и берёт первый заданный.
...
видно как «ожидающее» только ADMIN и самому синьору.
_Избегать_: процент синьора, ставка синьора, комиссия синьора
