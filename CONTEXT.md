...
перекрывает всё независимо от статуса — «В архиве». Одно название на статус во всех местах,
где он показывается (строка списка, шапка страницы проекта, левая навигация).
