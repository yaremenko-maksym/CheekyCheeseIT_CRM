...
export const JUNIOR_CONTRACT: {
  ...
  customVariables: [
    ...
    },
    {
      ...
      label: 'Строк конфіденційності після припинення (п. 7.1)',
      defaultValue: '3 (три) роки',
    },
  ...
  bodyMarkdown: `# ДОГОВІР ПРО НАДАННЯ ПОСЛУГ З РОЗРОБКИ ПЗ<br>SOFTWARE DEVELOPMENT SERVICES AGREEMENT
...
| та **Фізична особа — підприємець {{employeeName}}**, реєстраційний номер облікової картки платника податків (РНОКПП) {{rnokpp}}, зареєстрований як платник єдиного податку 3-ї групи згідно із законодавством України, надалі — «**Виконавець**», з іншої сторони, | and **{{employeeName}}, a private entrepreneur (FOP)**, taxpayer registration number (RNOKPP) {{rnokpp}}, being a single-tax payer of the 3rd group under the laws of Ukraine, hereinafter the "**Contractor**", of the other part, |
