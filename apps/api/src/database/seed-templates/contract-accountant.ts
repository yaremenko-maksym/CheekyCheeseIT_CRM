...
export const ACCOUNTANT_CONTRACT: {
  bodyMarkdown: string
  ...
  bodyMarkdown: `# ДОГОВІР ПРО НАДАННЯ ПОСЛУГ (БУХГАЛТЕРСЬКИЙ ОБЛІК / ФІНАНСИ)<br>SERVICES AGREEMENT (ACCOUNTING / FINANCE)
...
| 1.1. Виконавець зобов'язується за завданням Замовника надавати послуги з бухгалтерського обліку та фінансового адміністрування (надалі — «Послуги»), а Замовник зобов'язується приймати та оплачувати такі Послуги на умовах цього Договору. | 1.1. The Contractor undertakes, upon the Customer's assignment, to provide accounting and financial-administration services (the "Services"), and the Customer undertakes to accept and pay for such Services under the terms of this Agreement. |
| 1.2. Послуги включають, зокрема: | 1.2. The Services include, in particular: |
| 1.2.1. ведення бухгалтерського та управлінського обліку операцій компанії; | 1.2.1. maintaining the accounting and management records of the company's operations; |
| 1.2.2. валідацію (перевірку) транзакцій, поданих іншими спеціалістами; | 1.2.2. validating (verifying) transactions submitted by other specialists; |
| 1.2.3. підготовку рахунків та інвойсів; | 1.2.3. preparing invoices and bills; |
| 1.2.4. звірку виплат (зокрема виплат спеціалістам та партнерам); | 1.2.4. reconciling payments (including payments to specialists and partners); |
| 1.2.5. підготовку фінансової звітності та допоміжну фінансово-адміністративну підтримку. | 1.2.5. preparing financial reporting and providing related financial-administrative support. |
...
| 2.1.2. запитувати у Замовника інформацію та документи, необхідні для надання Послуг; | 2.1.2. request from the Customer the information and documents necessary to provide the Services; |
...
| 2.2.1. надавати Послуги своєчасно, сумлінно та на професійному рівні; | 2.2.1. provide the Services in a timely, diligent and professional manner; |
| 2.2.2. забезпечувати точність та повноту облікових даних у межах наданої Замовником інформації; | 2.2.2. ensure the accuracy and completeness of accounting data within the information provided by the Customer; |
| 2.2.3. негайно повідомляти Замовника про обставини, що перешкоджають належному наданню Послуг, або про виявлені суттєві розбіжності; | 2.2.3. promptly notify the Customer of any circumstances impeding proper performance or of any material discrepancies identified; |
...
| 3.1.1. надавати Виконавцю завдання та пріоритети щодо облікових і фінансових процесів; | 3.1.1. give the Contractor assignments and priorities regarding accounting and financial processes; |
...
| 3.1.3. одержувати від Виконавця інформацію та звіти про надані Послуги. | 3.1.3. obtain information and reports about the Services rendered. |
| 3.2. Замовник зобов'язується: | 3.2. The Customer undertakes to: |
| 3.2.1. своєчасно надавати Виконавцю первинні документи, дані та доступи, потрібні для надання Послуг; | 3.2.1. timely provide the Contractor with the primary documents, data and access needed for the Services; |
...
| 3.2.4. нести відповідальність за достовірність наданих Виконавцю первинних даних; Виконавець не відповідає за наслідки недостовірних або неповних даних, наданих Замовником. | 3.2.4. be responsible for the accuracy of the primary data provided to the Contractor; the Contractor is not liable for consequences of inaccurate or incomplete data provided by the Customer. |
| 3.2.5. не давати Виконавцю вказівок, що за змістом створюють ознаки трудових відносин. | 3.2.5. refrain from giving instructions that in substance create features of an employment relationship. |
...
| 5.1. За належно надані Послуги Замовник сплачує Виконавцю винагороду в розмірі **{{salary}} на місяць**. | 5.1. For duly rendered Services, the Customer pays the Contractor remuneration of **{{salary}} per month**. |
...
| 7.2. Конфіденційною є будь-яка непублічна інформація, що передається між Сторонами у зв'язку з Договором, зокрема: фінансові та облікові дані, суми та умови виплат, банківські реквізити, бізнес-плани, листування з контрагентами, доступи до систем. | 7.2. Confidential Information means any non-public information exchanged between the Parties in connection with the Agreement, including financial and accounting data, payment amounts and terms, bank details, business plans, correspondence with counterparties, and system access credentials. |
...
| Українська | English |
| --- | --- |
| **8. ІНТЕЛЕКТУАЛЬНА ВЛАСНІСТЬ ТА РОБОЧІ МАТЕРІАЛИ** | **8. INTELLECTUAL PROPERTY AND WORK PRODUCT** |
| 8.1. Усі фінансові документи, звіти, облікові реєстри, розрахунки та інші матеріали, створені Виконавцем під час надання Послуг, а також виключні майнові права інтелектуальної власності на них (у частині, що охороняється) переходять до Замовника з моменту їх створення (або з моменту оплати відповідного періоду). | 8.1. All financial documents, reports, accounting registers, calculations and other materials created by the Contractor while providing the Services, together with the exclusive economic intellectual-property rights therein (to the extent protectable), transfer to the Customer upon their creation (or upon payment for the relevant period). |
| 8.2. Виконавець гарантує, що такі матеріали не порушують прав третіх осіб. | 8.2. The Contractor warrants that such materials do not infringe third-party rights. |

| Українська | English |
| --- | --- |
| **9. ЗАХИСТ ДАНИХ** | **9. DATA PROTECTION** |
| 9.1. Якщо надання Послуг передбачає обробку персональних даних (зокрема даних спеціалістів, партнерів, контрагентів), Сторони дотримуються Закону України «Про захист персональних даних» № 2297-VI та, де застосовно, GDPR (Regulation (EU) 2016/679). | 9.1. Where the Services involve processing of personal data (including specialists', partners', counterparties' data), the Parties comply with the Law of Ukraine "On Personal Data Protection" No. 2297-VI and, where applicable, GDPR (Regulation (EU) 2016/679). |
...
| 10.4. Розірвання Договору не звільняє Сторони від виконання зобов'язань, що виникли до дати розірвання, зокрема оплати фактично наданих Послуг. | 10.4. Termination does not release the Parties from obligations arisen before the termination date, in particular payment for Services actually rendered. |
| 10.5. У разі припинення Договору Виконавець передає Замовнику всі фінансові документи, реєстри та робочі матеріали, створені під час надання Послуг. | 10.5. Upon termination, the Contractor hands over to the Customer all financial documents, registers and work product created while providing the Services. |
