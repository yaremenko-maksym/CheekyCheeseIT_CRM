...
export const uk: Dictionary = {
  ...
  home: {
    ...
    workP: 'За NDA ми не можемо називати клієнтів — але задачі, рішення й цифри саме такі, якими вони були насправді.',
    caseStudies: [
      {
        domain: 'ai',
        domainLabel: 'AI / ML',
    ...
    services: [
      {
        ...
        bullets: ['Обслуговування моделей і MLOps', 'LLM- і RAG-застосунки', 'Пайплайни даних і ознак'],
      },
      {
        domain: 'edtech',
        domainLabel: 'EdTech',
    ...
    processSteps: [
      ...
      },
      {
        stepNum: '02 / Розробка',
        title: 'Розробка',
        description: 'Senior-команди постачають щотижневі інкременти у вашому репозиторії та стеку, відкрито.',
      },
      {
        stepNum: '03 / Запуск',
        title: 'Запуск',
      ...
      },
      {
        ...
        title: 'Підтримка',
        description: 'Залишаємось на зв\'язку надовго — продуктивність, надійність і наступна ітерація.',
      },
    ],
  ...
  vacancy: {
    ...
    apply: {
      ...
      coverPlaceholder: 'Розкажіть про складну задачу, яку ви вирішували, і що хотіли б будувати у нас.',
      cvLabel: 'Резюме (CV)',
