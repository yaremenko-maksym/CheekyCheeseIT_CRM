...
export const ru: Dictionary = {
  ...
  home: {
    ...
    workP: 'По NDA мы не можем называть клиентов — но задачи, решения и цифры именно такие, какими они были на самом деле.',
    caseStudies: [
      {
        domain: 'ai',
        domainLabel: 'AI / ML',
    ...
    services: [
      {
        ...
        bullets: ['Обслуживание моделей и MLOps', 'LLM- и RAG-приложения', 'Пайплайны данных и признаков'],
      },
      {
        domain: 'edtech',
        domainLabel: 'EdTech',
    ...
    processSteps: [
      ...
      },
      {
        ...
        title: 'Разработка',
        description: 'Senior-команды поставляют еженедельные инкременты в вашем репозитории и стеке, открыто.',
      },
      {
        stepNum: '03 / Запуск',
        title: 'Запуск',
      ...
      },
      {
        ...
        title: 'Поддержка',
        description: 'Остаёмся на связи надолго — производительность, надёжность и следующая итерация.',
      },
    ],
  ...
  vacancy: {
    ...
    apply: {
      ...
      coverPlaceholder: 'Расскажите о сложной задаче, которую вы решали, и что хотели бы строить у нас.',
      cvLabel: 'Резюме (CV)',
      ...
      successBodyAfter: '. Рассматриваем каждый отклик и ответим в течение нескольких рабочих дней.',
