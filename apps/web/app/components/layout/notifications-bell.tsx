...
// task-notification-settings-ui (position 7b): extracted so the bell popup
// and the profile "Уведомления" settings tab share one icon mapping instead
// of a second 10-way switch drifting out of sync with this one.
