  ...
  return (
    <div className="space-y-4">
          ...
          >
            <div className="flex items-start justify-between gap-2">
              <p className="pt-1 text-xs font-medium uppercase tracking-wide text-muted-foreground">
                <Trans>Місце роботи {position}</Trans>
              </p>
              <div className="flex shrink-0 gap-1">
                <Button
                  ...
                  disabled={index === 0}
                  aria-label={t`Перемістити місце роботи ${position} вгору`}
                ...
                <Button
                  ...
                  aria-label={t`Перемістити місце роботи ${position} вниз`}
                ...
                <Button
                  ...
                  aria-label={t`Видалити місце роботи ${position}`}
            ...
            <div className="grid gap-2 sm:grid-cols-2">
              <Input
                ...
                aria-label={t`Посада, місце роботи ${position}`}
              ...
              <Input
                ...
                placeholder={t`Компанія`}
                aria-label={t`Компанія, місце роботи ${position}`}
            ...
            <Input
              ...
              placeholder={t`Період, наприклад 2021 — наст. час`}
              aria-label={t`Період, місце роботи ${position}`}
            ...
            <Textarea
              ...
              placeholder={t`Досягнення — по одному в рядку`}
              rows={4}
              aria-label={t`Досягнення, місце роботи ${position}`}
      ...
      >
        ...
        <Trans>Додати місце роботи</Trans>
      </Button>
    </div>
  )
}
