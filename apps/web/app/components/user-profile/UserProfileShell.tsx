...
export function UserProfileShell({ mode, userId, tab, onTabChange }: UserProfileShellProps) {
  ...
  // chrome-in-place: while loading, render the page chrome (StickyPageHeader +
  // placeholder avatar/tab-bar) so layout doesn't shift when data arrives.
  if (isLoading) {
    return (
      <div className="flex flex-col h-full min-h-0">
        <StickyPageHeader>
          {/* Avatar row skeleton — matches UserProfileHeader dimensions */}
        ...
        <div className="flex-1 min-h-0 overflow-y-auto pt-4 pb-6 px-6">
